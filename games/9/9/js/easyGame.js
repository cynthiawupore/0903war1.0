...
game.prototype.gameover = function() {
	...
	submitScore(parseInt(Attack.all_mub), Attack.player.kill);


    // alert(Attack.all_mub)


    // cynthia begin
    if(Attack.all_mub>300000){
