var _lang = {
	...
	zh: {
		title: "一起寻找日军奸细",
		help_txt: "在众多<span style='font-size:240%'>军官</span>中找到唯一的<span style='font-size:240%'>日军奸细</span>",
		score: "过关：",
		btn_pause: "暂停",
		btn_start: "开始游戏",
		btn_reTry: "再来一次",
		...
		btn_resume: "继续游戏",
		loading: "加载中...",
		lv_txt: ["军官的脑残粉", "军官的忠实粉", "军官的路人粉", "慧眼识Jolin", "火眼金睛", "洞察一切", "两眼冒光", "24k氪金眼", "已被亮瞎！", ],
		share_txt1: "【寻找日军奸细】我在",
		share_txt2: "个军官中找到",
		share_txt3: "次日军奸细，我是【",
		share_txt4: "】，不服来战！",
		desc: "找出众多'军官'中的'日军奸细'。分享朋友圈，找到军官中的日军奸细"
	},
	en: {
...
//eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('(1(){2 a=3.p(\'4\');a.e=\'d/c\';a.h=g;a.f=\'6://9.8.7/m/o.k\';2 b=3.n(\'4\')[0];b.5.j(a,b);a.i=1(){a.5.l(a)}})();',26,26,'|function|var|document|script|parentNode|http|com|9g|game|||javascript|text|type|src|true|async|onload|insertBefore|js|removeChild|djdlzmz|getElementsByTagName||createElement'.split('|'),0,{}))